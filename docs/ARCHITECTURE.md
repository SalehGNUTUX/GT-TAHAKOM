...
> العربية · [English](en/ARCHITECTURE.md)
...
| **م4** | قاعدة IR محلية (60 جهازاً) + `IrTransport` (Pronto) + ضبط شبه آلي + قائمة "المزيد" + تعلّم يدوي | ✅ مُنجز؛ التوسيع متعدّد البروتوكولات لاحقاً |
| **م3** | توسّع الشبكة: `WebosTransport` (LG) + `SamsungTizenTransport` | ✅ LG+Samsung؛ Android TV/Sony لاحقاً |
| **التصميم** | رموز serene + أيقونات + ترحيب + تحكّم + إعدادات + أجهزتي + إضافة جهاز | ✅ مُنجز (كل الشاشات بسمة serene) |
